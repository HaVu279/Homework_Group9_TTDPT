...
reconstructed = fft2(im).real.astype('complex128')
reconstructed .imag = fft2(im).imag
reconstructed  = 255 * ifft2(reconstructed).real
reconstructed  = reconstructed.astype('uint8')
imageio.imwrite('reconstructed .png', reconstructed )